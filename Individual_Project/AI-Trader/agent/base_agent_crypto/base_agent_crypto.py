...
from prompts.agent_prompt_crypto import get_agent_system_prompt_crypto as _get_prompt_default
from prompts.agent_prompt_crypto_risk import get_agent_system_prompt_crypto as _get_prompt_risk
from tools.general_tools import (extract_conversation, extract_tool_messages,
                                 get_config_value, write_config_value)

_PROMPT_VARIANTS = {
    None: _get_prompt_default,
    "default": _get_prompt_default,
    "risk": _get_prompt_risk,
}
...
class BaseAgentCrypto:
    ...
    def __init__(
        ...
        self._get_prompt = _PROMPT_VARIANTS.get(prompt_variant, _get_prompt_default)
    ...
    async def run_trading_session(self, today_date: str) -> None:
        ...
        self.agent = create_agent(
            self.model,
            tools=self.tools,
            system_prompt=self._get_prompt(today_date, self.signature, self.market, self.crypto_symbols),
        )
